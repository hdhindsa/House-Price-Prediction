...
decay_list = [3,1,0.1,0.3,0.01,0.03]
b_risk = 10000000
# find best decay from the decay_list to get best L2 regularized model performance
for i in decay_list:
    decay = i
    ...
    if best_risk < b_risk:
        ...
        b_epoch = best_epoch
        b_w = best_w
        b_risk_yaxis = risk_yaxis
        b_losses_yaxis = losses_yaxis



print('best risk = '+str(b_risk))
print('best epoch = '+str(b_epoch))
print('best decay = '+str(b_decay))
#print(best_w)
#print(d)
#print(e)
# Perform test by the weights yielding the best validation performance
_,_, test_perf = predict(X_test,b_w,y_test)
